    ...
    <div class="w_100 p_10">
      <form onsubmit="return checkSubject();" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/articleWrite.do">
          ...
          <div class="m_b10 flex justify_c_between">
            <input type="text" class="input_box w_80" id="articleSubject" name="articleSubject" placeholder="제목을 입력해주세요."/>
...
<script>
	function checkSubject() {
		var subject = $.trim($("#articleSubject").val());
		if( subject == 'deleted' ){
			alert("입력할 수 없는 제목입니다.");
			$("#articleSubject").val('');
